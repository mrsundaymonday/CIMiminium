                    ...
                    <div class="form-body">
                         <div class="modal-body mx-3">
                            <!-- <div class="md-form mb-5">
                                <label data-error="wrong" data-success="right" for="id_user">Id User</label>
                                <input type="text" name="id_user" id="id_user" class="form-control validate">                                
                            </div> -->
                            ...
                            <div class="md-form">
                                <label data-error="wrong" data-success="right" for="level">Level</label>
