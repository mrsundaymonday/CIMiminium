<!-- start: Mobile -->
    ...
    <script src="<?php echo base_url();?>assets/admin/js/plugins/maps/jquery.vmap.world.js"></script>
    <script src="<?php echo base_url();?>assets/admin/js/plugins/jquery.vmap.sampledata.js"></script>
    <script src="<?php echo base_url();?>assets/admin/js/plugins/chart.min.js"></script>
